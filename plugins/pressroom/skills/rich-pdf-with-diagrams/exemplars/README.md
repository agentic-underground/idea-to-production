...
| `05-foundry-arch.dot` | Pattern 1 + Pattern 3 (Multi-phase + Wide fan-out wrap) | Central TB flow (Roadmap → Lead Engineer → Phase Pool → Handler Pool → Ledger). Handler pool wraps to two rows of 4+3. Visible balance between left content and right ledger node. |
