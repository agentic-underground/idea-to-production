...
1. **SVG-math (free) — `layout-check.sh`.** Run
   [`layout-check.sh`](../../../../../doc/image-craft-study/toolchain/src/layout-check.sh) on the generator
...
2. **Cheap raster (free) — `raster-lint.sh`.** Run
   [`raster-lint.sh`](../../../../../doc/image-craft-study/toolchain/src/raster-lint.sh) on the render. It
