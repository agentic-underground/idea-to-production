#!/usr/bin/env bash
# marketplace-golden-signals.sh — dogfood OPERATE's observability on the MARKETPLACE ITSELF
...
# (a crashed operate cannot observe its own crash), exactly as the P1-11 gitleaks job is the
