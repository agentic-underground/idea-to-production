#!/usr/bin/env bash
# inject-welcome.sh — i2p SessionStart hook. If the project being opened ships a
...
# /i2p:define-welcome does. This script reads only the plugin's preamble and the
