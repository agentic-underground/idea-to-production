...
1. Lay out the nine phases (a cycle) — DISCOVER ▸ IDEATE ▸ DELIVER ▸ DESIGN ▸ BUILD ⇄ ASSURE ⇄ SECURE ▸
   ...
   and the artefact it produces. **DELIVER** sits between IDEATE and DESIGN, owned by the flow plugin
   (DELIVER) + `foundry:roadmapper` (roadmap intake → EARS/feature → dependency-ordered decomposition).
