...
> plugin, the **i2p** concierge is bound by the **three pillars** and the **SOLID self-improvement
...
- **Knowledge-parity** (≡ *knowledge-alignment*) — the concierge's whole job is to close the gap between
...
- **Waste-elimination** — remove waste in every form, *including rediscovery*. The concierge **delegates,
...
For a **concierge**, improvement is folding **discoverability feedback** back into itself: when a user
...
> `/i2p-help` line or tip, fixed once. The concierge composes with — never duplicates — the specialist
