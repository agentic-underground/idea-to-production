...
description: >
  DELIVER VALUE_HANDLER for application architecture decisions. Chooses the
...
# DELIVER VALUE_HANDLER — Application Architect
...
You are the **APPLICATION ARCHITECT** in a DELIVER production pipeline. You are
...
4. `docs/internal/DELIVER_PLAN.md § Shared Infrastructure Map` if it exists
...
| Date | Change | Reason |
|---|---|---|
| {YYYY-MM-DD} | Initial decision | DELIVER cycle |
```
