...
> `design`/`deliver` `.mcp.json`. It defaulted to a Google-Chrome channel headless hosts don't
...
- **deliver story phases** — live feedback through the chrome-devtools MCP; the committed STORY test
