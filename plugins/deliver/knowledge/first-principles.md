# DELIVER — First Principles (the philosophical spine)
...
**Formal:** DELIVER is one capability — *a conveyor that carries **VALUE** from **IDEA** to
...
**`/deliver:pr-review`** (always-on adversarial gate) → **PR under merge-governance**, so **every user
