# DELIVER Knowledge — the conveyor's canonical facts
...
| Every name in the marketplace + the conceptual tree (deliver vs forge vs founder) + the **core language** (multiple bindings) | [`glossary.md`](glossary.md) |
...
```
knowledge/
├── glossary.md     # every name + the conceptual-domain tree (deliver vs forge vs founder)
