...
> For DELIVER §11. The authoritative test pyramid policy for all projects
> driven through the DELIVER pipeline. Enforced by COVERAGE-REVIEWER at
...
DELIVER enforces coverage as a gate, not as an objective. The objective is
...
**All five layers must be present for every roadmap item processed by DELIVER.**
