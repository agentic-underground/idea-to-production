...
> software DELIVER builds** ([`hexagonal.md`](hexagonal.md)); the marketplace's *own* shape is the
...
- **deliver** is the core capability.
...
> the **standing target** for the `/deliver:self-improve` skill. It is the only place the
