...
forms. DELIVER applies the lean / Toyota Production System discipline to software development. The
governing intuition:
...
(*muri*), and overburden breeds outright waste (*muda*). DELIVER attacks all three.

| The M | What it is | In software it looks like | DELIVER's countermeasure |
|---|---|---|---|
...
*Muda* is the largest surface, so it gets the detailed treatment: DELIVER applies the **seven
wastes** of lean production to software development.

## The seven wastes (muda), applied to software

| Waste | In software it looks like | DELIVER's countermeasure |
|---|---|---|
...
DELIVER is aggressively averse to skipping a gate to "save time": the saving is illusory; the
defect just moves to a more expensive station.

## A standing duty, not a phase
Waste elimination is continuous — this is **kaizen**. The `inspector` audits DELIVER itself for
