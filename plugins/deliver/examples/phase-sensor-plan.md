...
|----------|------|----------|
| Phase 0 — plan missing → install deliver-plan | Happy | 009,010,011 |
| Phase 1 — EARS missing → install deliver-ears | Happy | 009,010,011 |
| Phase 2 — .feature missing → install deliver-feature | Happy | 009,010,011 |
| Phase 3 — tests missing → install deliver-test | Happy | 009,010,011 |
| Phase 5 — impl missing → install deliver-implement | Happy | 009,010,011 |
...
| `skills/phase-sensor/phases/phase-0.md` | CREATE | Plan phase definition + deliver-plan SKILL.md |
| `skills/phase-sensor/phases/phase-1.md` | CREATE | EARS phase definition + deliver-ears SKILL.md |
| `skills/phase-sensor/phases/phase-2.md` | CREATE | Feature phase definition + deliver-feature SKILL.md |
| `skills/phase-sensor/phases/phase-3.md` | CREATE | Test phase definition + deliver-test SKILL.md |
| `skills/phase-sensor/phases/phase-5.md` | CREATE | Implement phase definition + deliver-implement SKILL.md |
