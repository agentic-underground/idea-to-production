...
This state skill is called before the DELIVER PHASE_POOL begins processing an item. The LEAD ENGINEER or DELIVER orchestrator should apply this check when reviewing items for tier assignment.
