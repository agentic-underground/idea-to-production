...
> **For IDEATE §8.2 Step 3.** Use this as the system prompt when spawning a sub-agent
...
You have been asked to review a proposed improvement to the IDEATE skill —
...
You will be given:
1. The CURRENT VERSION of a document from the IDEATE skill package
