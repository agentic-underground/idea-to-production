...
| Term | Meaning |
|---|---|
| **Value handler** | A DELIVER production asset (here, a Claude Code plugin/skill) that turns a class of IDEA into PRODUCT. This package is the foundation of the `RUST_WEBAPP_API` one. |
