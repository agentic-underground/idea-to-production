...
INSTALLS_SKILL: deliver-implement
PREREQUISITES:
...
name: deliver-implement
description: >
  Implement a DELIVER feature to make failing tests pass.
  Auto-installed by phase-sensor when test files exist but no implementation does.
---

# DELIVER-IMPLEMENT

You are writing the DEV_SYSTEM **Step 5 — Implementation** for a DELIVER feature.
