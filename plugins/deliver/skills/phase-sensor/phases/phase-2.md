...
INSTALLS_SKILL: deliver-feature
PREREQUISITES:
...
name: deliver-feature
description: >
  Write Gherkin .feature files for an in-progress DELIVER feature.
  Auto-installed by phase-sensor when no .feature file exists.
---

# DELIVER-FEATURE

You are writing the DEV_SYSTEM **Step 2 — Feature Documentation** for a DELIVER feature.
...
6. The phase sensor will detect the `.feature` file and install `deliver-test` for Step 3.
