...
name: deliver-ears
description: >
  Write EARS specifications for an in-progress DELIVER feature.
  Auto-installed by phase-sensor when EARS IDs are absent from SPECIFICATION.ears.md.
---

# DELIVER-EARS

You are writing the DEV_SYSTEM **Step 1 — EARS Specification** for a DELIVER feature.
...
7. The phase sensor will detect the new EARS IDs and install `deliver-feature` for Step 2.
