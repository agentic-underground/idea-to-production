#!/usr/bin/env bash
# DEV_SYSTEM Phase Sensor for DELIVER.
...
# sentinel audit log (`docs/internal/DELIVER_PLAN.md` under `## Sentinel Audit Log`, per
...
cross_check_sentinels() {
    local plan="${PROJECT}/docs/internal/DELIVER_PLAN.md"
