...
## 1 · Core vocabulary
- **deliver** — the BUILD_SYSTEM; the machine FOUNDER orchestrates.
...
1. `deliver -help` (project `./.claude`, or the user's global config if present): learn the stage list and,
