...
name: self-improve
description: >
  Improve IDEATOR itself by folding downstream feedback back into its challenge protocol and the IDEA-
  package contract — and by self-cleaving over-broad elements. Trigger with /ideator:self-improve (or
...
IDEATOR gets sharper from **ideation-feedback** — emitted by FOUNDRY's LEARN station / FOUNDER when a
...
Each pass must leave IDEATOR **measurably better at reaching knowledge-parity before hand-off** — at
