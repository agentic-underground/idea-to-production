...
too small to read at embed width — design "review" at 5.9px inline, ideate "the pain, shared" at 5.2px,
...
**Figure(s)/animation(s) fixed in this round:** `design-critique`, `ideate-converge`, `publish-press`.
