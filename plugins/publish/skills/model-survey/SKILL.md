...
The survey is **done** when, for every model in `comfyui-experiment/manifest.json`: all five category cells
...
Resolve `SURVEY_DIR=comfyui-experiment`; `SCRIPTS=${CLAUDE_PLUGIN_ROOT}/skills/model-survey/scripts`. Read
