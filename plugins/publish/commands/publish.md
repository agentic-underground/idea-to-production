---
description: Publish project material as an article, diagrams, or a print-quality PDF — the single front door to PUBLISH (writer + diagram-studio + rich-pdf).
---

Orchestrate the PUBLISH pipeline to turn project material into publication-grade output.
