...
name: handler-chart
description: >
  PUBLISH GRAPHICAL VALUE_HANDLER for quantitative charts. Consumes an ILLUSTRATOR SPEC (with data) and
...
# PUBLISH GRAPHICAL VALUE_HANDLER — Chart
...
Pick whichever is available (`/publish:check` reports them); the chart, not the engine, is the deliverable.
