...
description: >
  PUBLISH GRAPHICAL VALUE_HANDLER for generative raster figures. Consumes an ILLUSTRATOR SPEC and emits one
...
# PUBLISH GRAPHICAL VALUE_HANDLER — ComfyUI (raster, generative, multi-stage)
