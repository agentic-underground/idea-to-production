# OPERATE canon — the named discipline behind MISSION-CONTROL

> The OPERATE phase is not "watch the dashboards and hope." It is a body of named, battle-tested practice.
> MISSION-CONTROL grounds every skill in this canon so its judgments cite a discipline, not a vibe. This is
...
- **SLA** — the *contractual* consequence of missing an SLO (credits, penalties). MISSION-CONTROL works at
