...
msg='flow board removed (roadmap #39): the flow-server is an MCP stdio core only — read the roadmap via the flow-server MCP verbs (render_roadmap / list_items), e.g. /mission-control:flow or /mission-control:flow-setup.'
