...
The lookup table `dependency-audit` reads to know *how* to audit each ecosystem it detects. Run
...
## Severity mapping (native → SENTINEL)

| Native severity | SENTINEL risk |
|---|---|
| critical | CRITICAL |
| high | HIGH |
