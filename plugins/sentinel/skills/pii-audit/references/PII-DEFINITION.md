...
This document defines what counts as Personally Identifiable Information (PII) for the purposes of the `pii-audit` skill. Use this taxonomy when training, reviewing, or improving the audit agents.
...
The `pii-audit` skill uses this taxonomy to:
