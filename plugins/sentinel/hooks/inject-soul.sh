...
#
# CANONICAL COPY — byte-identical across all six plugins (CI: scripts/verify-prereqs.sh
...
# Fallbacks: a stable per-launch key still dedups the 6 hooks rather than injecting 6x.
