...
Run the consolidated **security-gate** skill.
...
Fan out the three SENTINEL audits in parallel — **pii-audit** (personal data), **secret-scan**
(credentials), **dependency-audit** (supply chain) — consolidate and deduplicate their findings,
...
This is the SECURITY value-station the `foundry` plugin invokes before DELIVERY when SENTINEL is
