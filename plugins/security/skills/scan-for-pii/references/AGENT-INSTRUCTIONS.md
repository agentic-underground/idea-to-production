...
This document provides detailed instructions for each of the four parallel agents that execute in the `scan-for-pii` skill. Each agent runs independently and returns findings in a standardized markdown format for consolidation.
