...
- **Knowledge-parity** (≡ *knowledge-alignment*) — understand the design intent completely **before**
  judging or making. ATELIER never critiques against unknown goals: it recovers the *customer*, the
...
- **Quality-first** (≡ *quality-confidence*) — quality is built in, not inspected in; a gate is never
  weakened to make progress. ATELIER's gate is the **design-fitness rubric**
...
Concretely, ATELIER improves by folding **design feedback** back into its canon and its fitness rubric:
...
> fix is upstream: a better-articulated canon rule or rubric weight, fixed once. ATELIER composes with —
