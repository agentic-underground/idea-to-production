---
description: Inspect the FOUNDRY system itself — audit skills, agents, and knowledge for drift, gaps, and duplication; produce a severity-ranked report.
---

Inspect FOUNDRY.

Invoke the **inspector** agent to run an independent, critical audit of the plugin
(`${CLAUDE_PLUGIN_ROOT}`): read the skills, agents, and `knowledge/` docs; build a fresh
