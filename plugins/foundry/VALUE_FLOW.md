...
> V&V, foundry) and SECURE (security, the secure plugin) are separate first-class gates. The canonical lifecycle
...
- **SECURITY** *(companion: `secure` plugin)* — when installed, foundry's release path can run
