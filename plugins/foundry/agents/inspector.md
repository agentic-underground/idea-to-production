...
description: >
  ...
  and the companion plugins (security, publish) when present. Triggered by user
...
When asked to inspect FOUNDRY, also sweep `security`/`publish` for any finding-class that is marketplace-
