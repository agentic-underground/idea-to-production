---
name: ds-step-0-plan
description: Creates and maintains the implementation plan artifact with checklist and resumption instructions. Spawned by the lifecycle-orchestrator or FOUNDRY at the start of a new roadmap item's lifecycle.
