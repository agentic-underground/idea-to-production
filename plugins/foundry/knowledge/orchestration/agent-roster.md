...
> For FOUNDRY §7–§9. The complete catalogue of agents used in a FOUNDRY cycle:
...
**Spawned by:** FOUNDRY orchestrator at cycle start for each roadmap item
...
**Spawned by:** FOUNDRY orchestrator after EARS-REVIEWER PASS
...
**Spawned by:** FOUNDRY orchestrator after BDD-REVIEWER PASS
...
**Spawned by:** FOUNDRY orchestrator after TEST-DESIGN-REVIEWER PASS
**Input context:** All previous sentinels + test files + FOUNDRY_PLAN shared-infra map + SMU
...
**Phase:** 5 — Story Tests
**Spawned by:** FOUNDRY orchestrator after COVERAGE-REVIEWER PASS (Phase 4)
...
**Spawned:** When a roadmap item enters the Development System (inside or outside FOUNDRY)
