...
> For FOUNDRY §5 (LEAD ENGINEER). Template for the SMU document created at
...
foundation** for all activity in a FOUNDRY cycle. It answers:
...
| Date | Change | Reason |
|---|---|---|
| [ISO date] | Initial creation | FOUNDRY cycle start |
```
