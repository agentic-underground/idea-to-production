...
This skill carries the SOLID self-improvement covenant. If spec conformance gaps are consistently found at step-6 (tests pass but intent is not met), the EARS statements or Gherkin scenarios are underspecified. If regressions consistently appear, the isolation between features needs architectural attention. Both patterns warrant FOUNDRY §14 escalation.
