...
3. **Assemble `PREREQUISITES.md`** in the **current project root**. Build the document from each
   ...
   ## FOUNDRY                  (from 10-foundry.md — toolchains, chrome-devtools MCP, debuggers, LSP)
   ## SECURITY  (if installed) (from 20-security.md — scanners)
   ## PUBLISH (if installed) (from 30-publish.md — dual-engine typesetting + DTP)
...
that contains `scripts/`). When foundry was installed **standalone** there is no marketplace root
