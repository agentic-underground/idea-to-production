...
Each `✗` prints its install hint. For the full rationale and Ansible fragments, see the marketplace
[`PREREQUISITES/`](../../../../PREREQUISITES/) folder — `10-foundry.md`, `40-mcp.md`, `45-lsp.md`.
