...
`doc/image-craft-study/toolchain/src/layout-check.sh <generator.sh>`:
...
`doc/image-craft-study/gates/gate-reviewer-calibration.md` — the "review the reviewers" proof:
...
`doc/image-craft-study/toolchain/src/reslow.sh`: when a `TIMING.tsv` is present, use its per-frame hold
...
`doc/image-craft-study/toolchain/src/composite-depth.sh <frames_dir> [ground]` — per PNG frame:
...
`doc/image-craft-study/toolchain/src/build-plugin-banners.sh` — reuses `doc/images/readme-banner.svg`
...
**New**
- `doc/image-craft-study/toolchain/src/layout-check.sh`
- `doc/image-craft-study/toolchain/src/composite-depth.sh`
- `doc/image-craft-study/toolchain/src/build-plugin-banners.sh`
- `doc/image-craft-study/gates/gate-reviewer-calibration.md`

**Modify**
- `doc/image-craft-study/toolchain/src/reslow.sh` (+ `TIMING.tsv` support)
