...
- **Flagship #1 — lifecycle cycle** (`docs/images/lifecycle-cycle.gif`) — embedded in `plugins/i2p/knowledge/product-lifecycle.md`.
- **Flagship #2 — animated masthead** (`docs/images/masthead-cycle.gif`) — the wide-and-short **root README front
