...
- [Plugin-count drift](project_plugin-count-drift.md) — nine plugins; hardcoded counts in docs/figures/alt-text drift; CI Check E=SOUL.md, F=inject-soul.sh (don't swap)
