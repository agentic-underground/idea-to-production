...
description: pressroom plugin lacks foundry's knowledge/ tree — handlers copied from foundry templates import broken knowledge links
metadata:
  type: project
---

When a new pressroom value-handler is authored by copying a foundry handler template
(e.g. foundry/agents/handler-rust.md), the foundry knowledge-link scaffold gets imported
...
So these foundry refs are BROKEN in pressroom: implementation-covenant.md,
