...
PR #244 "ONE BROWSER" removed the shipped `@playwright/mcp` server (foundry/.mcp.json + deleted design/.mcp.json) and migrated to the **host-provided** `chrome-devtools` MCP (unprefixed `mcp__chrome-devtools__*`).
