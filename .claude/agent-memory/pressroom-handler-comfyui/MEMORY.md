# Pressroom ComfyUI Handler — Memory Index

- [Template _meta strip](feedback_template_meta_strip.md) — delete `_meta` from txt2img-basic.json before POST or the prompt is silently rejected (empty prompt_id)
- [ComfyUI endpoint](reference_comfyui-endpoint.md) — reachable server 10.10.10.163:8188, model availability (canon default IP was unreachable)
- [i2p hero is a ComfyUI dark-key asset](project_i2p-hero-comfyui.md) — reproducible recipe + dark-host assumption for plugins/i2p/diagrams/hero.png
