---
name: design-hero-comfyui
description: The design plugin hero.png is a ComfyUI dark-key raster; reproducible recipe + the SDXL prompt-tension lesson (amber-dominant vs floating-cyan-wireframe).
metadata:
  type: project
---

`plugins/design/diagrams/hero.png` is a generated dark-key raster (opaque RGB, no alpha — assumes a dark-ish host, per dark-mode canon §4 and [[i2p-hero-comfyui]]).
