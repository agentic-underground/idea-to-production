# 30 — PUBLISH prerequisites

PUBLISH is **dual-engine**: it can typeset with **Typst** *or* **LaTeX**, and renders diagrams with
...
|---|---|---|---|---|
| `typst` | recommended | `typst --version` | Fast, single-pass, **no TeX install**; default when present. 0.14.x validated. Template: [`typst-template.md`](../plugins/publish/skills/rich-pdf-with-diagrams/references/typst-template.md). | `cargo install typst-cli` or release binary |
...
> **No MCP applies.** PUBLISH renders through local engines (typst/LaTeX, Graphviz, pandoc) — there is
