...
STRIP="$ROOT/docs/internal/image-craft-study/toolchain/proof/masthead-cycle-strip.png"
...
# (no raster compositing — the composite-depth vignette was rejected; frames stay flat SVG)
